...
//            }
//            else if (randomNumber >= 28 && randomNumber <= 37)
//            { // 15.4% probability
//                spinResult[spin] = "Grapes";
//            }
//            else if (randomNumber >= 38 && randomNumber <= 46)
//            { // 13.8% probability
//                spinResult[spin] = "Banana";
//            }
//            else if (randomNumber >= 47 && randomNumber <= 54)
//            { // 12.3% probability
//                spinResult[spin] = "Orange";
//            }
//            else if (randomNumber >= 55 && randomNumber <= 59)
//            { //  7.7% probability
//                spinResult[spin] = "Cherry";
//            }
//            else if (randomNumber >= 60 && randomNumber <= 62)
//            { //  4.6% probability
//                spinResult[spin] = "Bar";
//            }
